...
static const char *fonts[]          = { "Font Awesome 5 Free Solid:size=12" };
static const char dmenufont[]       = "Font Awesome 5 Free Solid:size=12";
// Pywal color import
#include "/home/joel/.cache/wal/colors-wal-dwm.h"
